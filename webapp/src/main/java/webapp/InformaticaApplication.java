 ...
 * 
 */
public class InformaticaApplication extends IsisWicketApplication {
    ...
    private static String readLines(final String resourceName) {
        try {
            List<String> readLines = Resources.readLines(Resources.getResource(InformaticaApplication.class, resourceName), Charset.defaultCharset());
